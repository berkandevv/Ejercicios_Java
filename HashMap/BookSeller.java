...
/**
 * Programa que genera un resumen del inventario de libros
 * por categoría, donde las categorías son representadas por una lista de letras
 * y los libros en el inventario están etiquetados por un código de categoría (letra) 
 * y una cantidad.
 */
...
public class BookSeller {
    ...
    public static String stockSummary(String[] stockList, String[] categories) {
        ...
        // Recorrer el hashmap para comprobar si la categoría está en la lista de
        // categorías e iniciar el total a 0
        for (int i = 0; i < categories.length; i++) {
            categoryTotals.put(categories[i], 0);
        }

        // Recorrer la lista de existencias de cada libro y separa el código y la
        // cantidad
